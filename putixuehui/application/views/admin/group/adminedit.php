<div class="rightpanel">
    <div class="mian"> 
        ...
        <!-- end 面包屑 -->
        <form name="uploadFrom" id="uploadFrom" action="<?php echo site_url('admin/groups/adminedit/'.$user['id']);?>" method="post" >
            <!-- 表单 -->
            <div class="col_form mrtop">
                ...
                <div class="col_forms">
                    <dl>
                        ...
                        <dd>
                            <input type="text" name="admin_username" class="btn_txt" value="<?php echo $user['username']?>"  />
                        </dd>
                        <dd class="error"></dd>
                    </dl>
                </div>
                <div class="col_forms">
                    <dl>
                        ...
                        <dd>
                            <input type="text" name="email" class="btn_txt" value="<?php echo $user['email']?>"  />
                        </dd>
                        <dd class="error"></dd>
                    </dl>
                </div>
                <div class="col_forms">
                    <dl>
                        ...
                        <dd>
                            <input type="text" name="name" class="btn_txt" value="<?php echo $user['name']?>" />
                        </dd>
                        <dd class="error"></dd>
                    </dl>
                </div>
                    ...
                    <dl>
                        ...
                        <dd>
                            <select name="permissions" class="btn_txt">
                                ...
                                <option value="<?php echo $list['id']?>" <?php if($list['id']==$user['permission']){?>selected<?php }?>><?php echo $list['name']?></option>
                                <?php endforeach;?>
                            </select>
                        </dd>
                        <dd class="error"></dd>
                    ...
                    <dl>
                        ...
                        <dd>
                            <select name="manger_group_id" class="btn_txt" >
                                ...
                                <option value="<?php echo $list['id']?>" <?php if($user['manger_group_id']==$list['id']) echo 'selected="selected"';?>><?php echo $list['name']?>【组长：<?php echo $list['leader'];?>】</option>
                                <?php }};?>
                            </select>
                        </dd>
                        <dd class="error"></dd>
